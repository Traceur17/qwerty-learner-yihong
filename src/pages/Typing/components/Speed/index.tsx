...
export default function Speed() {
  ...
  return (
    <div className="my-card flex w-full max-w-4xl rounded-xl bg-white px-3 py-6 opacity-50 transition-colors duration-300 dark:bg-gray-800 md:px-4 md:py-8 xl:max-w-5xl">
